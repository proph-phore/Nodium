Contributing to Nodium Core
============================

The Nodium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodium Core project, and is not to be
confused with overall Nodium Network Protocol consensus changes.

Whether a pull request is merged into Nodium Core rests with the project merge
...
Patches that change Nodium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nodium consensus, it must have been
...
The project leader is the release manager for each Nodium Core release.
