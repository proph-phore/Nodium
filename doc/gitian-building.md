...
git clone https://github.com/Nodium-crypto/Nodium.git
cd Nodium
...
```bash
    ...
    From https://github.com/Nodium-crypto/Nodium
...
For example:
```bash
URL=https://github.com/crowning-/Nodium.git
...
[Nodium/gitian.sigs](https://github.com/Nodium-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
