Nodium Core version 2.3.0 is now available from:

  <https://github.com/Nodium-project/Nodium/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/Nodium-project/Nodium/issues>
...
[
  {
    ...
    winner: {
        address: addr,    (string) Nodium MN Address,
...
Nodium Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for Nodium (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with Nodium (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Nodium-project-translations/).
