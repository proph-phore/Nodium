            ...
            while (true) {
                ...
                if (!SelectCoins(nTotalValue, setCoins, nValueIn, coinControl, coin_type, useIX)) {
                    if (coin_type == ALL_COINS) {
                        ...
                        strFailReason = _("Unable to locate enough CoinMixing non-denominated funds for this transaction that are not equal 10000 XN.");
                    } else {
                    ...
                    if (useIX) {
                        strFailReason += " " + _("SwiftNode requires inputs with at least 6 confirmations, you might need to wait a few minutes and try again.");
                    }
